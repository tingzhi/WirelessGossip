...
python analysis.py maxtimecmd_400.txt maxhopscmd_400.txt > output_400.txt
python analysis.py maxtimecmd_550.txt maxhopscmd_550.txt > output_550.txt
python analysis.py maxtimecmd_700.txt maxhopscmd_700.txt > output_700.txt
python analysis.py maxtimecmd_850.txt maxhopscmd_850.txt > output_850.txt
python analysis.py maxtimecmd_1000.txt maxhopscmd_1000.txt > output_1000.txt
python analysis.py maxtimecmd_1150.txt maxhopscmd_1150.txt > output_1150.txt
python analysis.py maxtimecmd_1300.txt maxhopscmd_1300.txt > output_1300.txt
python analysis.py maxtimecmd_1450.txt maxhopscmd_1450.txt > output_1450.txt
python analysis.py maxtimecmd_1600.txt maxhopscmd_1600.txt > output_1600.txt
